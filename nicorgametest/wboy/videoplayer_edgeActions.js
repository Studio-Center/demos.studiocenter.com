...
//Edge symbol: 'stage'
(function(symbolName){Symbol.bindSymbolAction(compId,symbolName,"creationComplete",function(sym,e){var youtubevid=$("<iframe/>");sym.$("vcontainer").append(youtubevid);youtubevid.attr('type','text/html');youtubevid.attr('width','640');youtubevid.attr('height','360');youtubevid.attr('src','http://www.studiocenter.com/DEMOS/nicorgametest/whiteboy.mp4');youtubevid.attr('frameborder','0');youtubevid.attr('allowfullscreen','0');});
//Edge binding end
